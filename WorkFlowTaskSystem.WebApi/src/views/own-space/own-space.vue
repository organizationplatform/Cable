                ...
                >
                    ...
                    <FormItem label="用户手机：" prop="phoneNumber" >
                        <div style="display:inline-block;width:204px;">
                            <Input v-model="userForm.phoneNumber"   @on-keydown="hasChangePhone"></Input>
                        </div>
                    ...
                    <FormItem label="部门：">
                        <span>{{ userForm.organizationUnitNames }}</span>
                    </FormItem>
                    <FormItem label="登录密码：">
...
export default {
    ...
    methods: {
        ...
        saveEdit () {
            this.$refs['userForm'].validate((valid) => {
                if (valid) {
                    if (this.phoneHasChanged && this.userForm.phoneNumber !== this.initPhone) { // 手机号码修改过了而且修改之后的手机号和原来的不一样
        ...
        cancelInputCodeBox () {
            ...
            this.userForm.phoneNumber = this.initPhone;
        },
        submitCode () {
            let vm = this;
