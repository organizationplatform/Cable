    ...
    /*{
        ...
        children: [
            { 
                ...
                title: '组织架构管理',
                 name: 'organization', 
                 permission:'Pages.OrganizationUnits.Nav',
                 component: () => import('@/views/baseInfo/organization.vue') 
             },
            { 
                path: 'user',
                 icon: 'compose',
                title: '用户管理',
                 name: 'user', 
                 permission:'Pages.Users.Nav',
                 component: () => import('@/views/baseInfo/user.vue') 
             },
            { 
                path: 'role',
                 icon: 'compose',
                title: '角色管理',
                 name: 'role', 
                 permission:'Pages.Roles.Nav',
                 component: () => import('@/views/baseInfo/role.vue') 
             },
              { 
                path: 'permission',
                 icon: 'compose',
                title: '权限管理',
                 name: 'permission', 
                 permission:'Pages.Permissions.Nav',
                 component: () => import('@/views/baseInfo/permission.vue') 
             },
             { 
                ...
                title: '模板管理',
                 ...
                 component: () => import('@/views/baseInfo/templatemanager.vue') 
             }
